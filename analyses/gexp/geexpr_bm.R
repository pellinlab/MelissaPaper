...
nameFiles = paste0("/", c(paste0("SRR1192440", 0:2), c("SRR1867792", "SRR1909613", paste0("SRR190963", 7:9))), 
                   "ReadsPerGene.out.tab")
nameDatas = c(paste0("bmsc", 1:8))
...
write.table(mean_expr, file = paste0(mainFolder,"/analyses/data/soft/bmsc_mean_expr.csv"), quote = F, sep = ",", row.names = F, col.names = T)
