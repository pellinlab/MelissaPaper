...
da = paste0(dataFolder, c("b0bE_11_B0BE_Sixetal_G_.bed"   ,         
                          "b0bE_11_B0BE_Sixetal_Mono_.bed",
                          "b0bE_36_B0BE_Sixetal_G_.bed"   ,
                          "b0bE_36_B0BE_Sixetal_Mono_.bed",
                          "b0bE_48_B0BE_Sixetal_G_.bed"   ,  
                          "b0bE_48_B0BE_Sixetal_Mono_.bed"))
cv = data.frame(time = rep(c(11L, 36L, 48L) - 0L, each = 2),
                type = rep(c("G", "Mono"), times = 3))
...
StoreResults(integrSiteObject, result, nameFileResult = "/analyses/results/gt_ov_b0be_mye.csv", storeTable = F)
